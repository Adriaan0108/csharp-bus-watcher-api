...
namespace csharp_bus_watcher_api.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "IncidentReportFeedbacks",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    IncidentReportId = table.Column<int>(type: "integer", nullable: false),
                    CreatedByDeviceId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IncidentReportFeedbacks", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Name = table.Column<string>(type: "text", nullable: false),
                    OriginStopId = table.Column<int>(type: "integer", nullable: false),
                    DestinationStopId = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeviceBuses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DeviceBuses_Buses_BusId",
                        column: x => x.BusId,
                        principalTable: "Buses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DeviceBuses_Devices_DeviceId",
                        column: x => x.DeviceId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeviceBuses_BusId",
                table: "DeviceBuses",
                column: "BusId");

            migrationBuilder.CreateIndex(
                name: "IX_DeviceBuses_DeviceId",
                table: "DeviceBuses",
                column: "DeviceId");
